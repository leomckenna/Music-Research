...
SESSION_CSV = os.path.join(BASE_DIR, "control_forleo.csv")
OUTPUT_CSV = os.path.join(BASE_DIR, "control_files.csv")
...
ADDITIONAL_KEYWORDS = ["full set", "full concert", "rare footage", "archival", "classic"]

SEARCH_QUERIES = [
    f"{row['datelocation']} {row['group_name']} live OR session OR concert OR gig OR performance OR jazz OR set OR recording"
